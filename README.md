...
functions_st.cpp includes definitions of functions for self-triggering models (single event type).
functions_ct.cpp includes definitions of functions for competing-triggering models (multiple event types).
In each of the .cpp files, code for generating data, calculating partial likelihood, gradient and Hessian matrices are provided.
